...
public class putMissingName {
	...
	public void testPutResponseStatusLine()
	{
		...
		System.out.println("Status code for put request is" + statusLine);
	...
	public void validateHeaders() throws ParseException
	{
		...
		AssertJUnit.assertEquals("waitress",Server);
		AssertJUnit.assertEquals("application/json",type);
		AssertJUnit.assertEquals("0",Length);
	}
	...
	public void validateDB() throws ParseException
	{
		...
		Assert.assertEquals(price, "130.00");
